...
public final class ServicePresets {
	...
	public static final String PRIMARY_OBJECT_MEDIA_TYPE = MediaType.APPLICATION_JSON;
	public static final String SECONDARY_OBJECT_MEDIA_TYPE = MediaType.APPLICATION_XML;
